...
def _build_evidence(
    ...
    evidence = [
        ...
        SourceEvidence(ref="opportunity.nice_to_haves", text=" ".join(opportunity.nice_to_haves)),
        ...
        SourceEvidence(ref="opportunity.company_context", text=opportunity.company_context),
...
def _source_map(bundle: ContextBundle, request: DraftRequest) -> dict[str, str]:
    ...
    sources = {
        ...
        "opportunity.company_context": opportunity.company_context,
